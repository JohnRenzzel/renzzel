...
<template>
  <div class="short-hero-container w-full mt-[-1rem]">
    <div
      class="relative z-10 flex top-[11vh] justify-center items-center"
      data-aos="fade-right"
    ...
    <div class="white-shape">
      <svg
        class="mx-auto invert rotate-180 absolute left-0 w-1/2 bottom-0 h-20"
